...
#define MAX_SPEED 22.12848      // m/s
//#define MAX_ACC   0.10013696    // m/s^2
#define MAX_ACC   1   // m/s^2
        ...
        if (event == "telemetry") {
          ...
          if (previous_path_x.size() > 0) {
            ...
            car_d = end_path_d;
					...
					planner.update_vehicle_state(car_x, car_y, car_yaw, car_speed, car_d, car_s, 
																				previous_path_x, previous_path_y);
					vector<vector<double>> next_trajectory = planner.next_path(sensor_fusion);
